			...
			<?php
				if (isset($_POST['uname'])) 
				{
					...
					if($resetadmno!="" && $nrows==1)
					{
						...
						mysql_query("update credentials set password='school' where username='$resetadmno'");
						//echo "<script type='text/javascript'>alert('admno correct');</script>";
						echo "<script>document.getElementById('resetpassinfo').style.display='none';</script>";
							...
							<table align='center'>
								<tr>
									<td colspan='2'><h4 id='' style='color:CC00FF; float:left'><font size='5px'>Successfully Student Password got Reset</font></h4></td>
								
								</tr>
								
								<tr>
									<td><br/><br/><a href='admin_reset_stud.php'>Reset Another Student</a></td>

...
<div class="wrap">
	<div class="main">
			<center>
			<div id="deleteteacher" style="display:">
			...
			<div id="viewstudinfodetails" style="display:">
							...
							<?php	
								...
								{ 
									...
									$query = mysql_query("select * from staff_info where username='$deleteadmno'");
									$nrows = mysql_num_rows($query);
									echo "<script>alert('');</script>";
									if($deleteadmno!="" && $nrows==1)
									{
										
										mysql_query("delete from staff_info where username='$deleteadmno'") or die("query failed");
										...
										echo "<script>document.getElementById('deleteteacher').style.display='none';</script>";
										echo "<div id='afterdeleteteacher' style='display:;width:;float:center;margin-top:20px;'>
										<table align='center'>
											<tr>
												<td colspan='2'><h4 id='' style='color:CC00FF; float:left'><font size='5px'>Teacher Deleted Successfully</font></h4></td>
											
											</tr>
											
											<tr>
												<td><br/><br/><a href='admin_delete_teacher.php'>Delete Another teacher</a></td>
